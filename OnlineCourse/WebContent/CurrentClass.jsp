	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#" style="color: black"><h5>Lớp
								học của tôi</h5></a></li>
				</ol>

				<div id="hide0">
					<button onclick="Toggle(div1,div2)">Thêm sinh viên vào lớp
						học</button>
					&nbsp;
					<button onclick="Toggle(div2,div1)">Xóa sinh viên khỏi lớp
						học</button>
					<br>
					<br>
				</div>
				...
				<form action="LoadList" method="get">
					<input type="hidden" name="classid" id="cid"
						value=<%=request.getAttribute("classid")%>> <input
						type="hidden" name="userid" id="sid"
				...
				<div id="hide1">
					<form action="AddRemoveStudent" method="get">
						<input type="hidden" name="userid" id="sid"
							value=<%=request.getAttribute("userid")%>> <input
							type="hidden" name="classid" id="vid"
							value=<%=request.getAttribute("classid")%>> <br>
						<input type="hidden" name="action" id="act">
						<div id="div1" style="display: none;">
							Mã số sinh viên cần thêm: <input type="text" name="newstudentid"
								id="input1"><input type="submit" value="Lưu"
								onclick="DoAction(1)">
						</div>
						<div id="div2" style="display: none;">
							Mã số sinh viên cần xóa: <input type="text" name="oldstudentid"
								id="input2"><input type="submit" value="Xóa"
								onclick="DoAction(2)">
						</div>
						<br>
					</form>
