	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			<li class="nav-item active"><a class="nav-link" href=""> <i
					class="fas fa-fw fa-tachometer-alt"></i> <span>Giao Diện</span>
			</a></li>
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> <i class="fas fa-fw fa-folder"></i> <span>Trang</span>
			</a>
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<h6 class="dropdown-header">Màn hình đăng nhập:</h6>
					<a class="dropdown-item" href="login.html">Đăng nhập</a> <a
						class="dropdown-item" href="register.html">Đăng kí</a> <a
						class="dropdown-item" href="forgot-password.html">Quên mật
						khẩu</a>
					<div class="dropdown-divider"></div>
			...
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> <i class="fas fa-cubes"></i> <span>Quản
						lý thành viên</span>
			</a>

				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<h6 class="dropdown-item">Bao gồm:</h6>
					<a class="dropdown-item" href="thanhvien.html">Danh sách thành
						viên</a> <a class="dropdown-item" href="*">Thêm</a> <a
						class="dropdown-item" href="*">Sửa</a> <a class="dropdown-item"
						href="*">Xóa</a> <a class="dropdown-item" href="*">Tìm kiếm</a>
				</div></li>
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					<h6 class="dropdown-item">Bao gồm:</h6>
					<a class="dropdown-item" href="LoadList">Danh sách đề thi</a> <a
						class="dropdown-item" href="*">Upload</a> <a class="dropdown-item"
						href="*">Sửa</a> <a class="dropdown-item" href="*">Xóa</a> <a
						class="dropdown-item" href="*">Tìm kiếm</a>
				</div></li>
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="#" id="pagesDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#" style="color: black"><h5>Quản
								lý đề thi</h5></a></li>
				</ol>

				<form action="test" method="post">
					<input id="hide1" type="hidden" name="testid" value="0"> <input
						id="hide2" type="hidden" name="quantity" value="0"> <input
