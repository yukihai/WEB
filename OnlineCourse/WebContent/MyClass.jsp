	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			<li class="nav-item active"><a class="nav-link"
				href=""> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Trang chủ</span>
			</a></li>
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div id="hide0">
					<button onclick="Toggle(div1,div2)">Thêm lớp học</button>
					<button onclick="Toggle(div2,div1)">Xóa lớp học</button>
				</div>

				<form action="AddClass" method="get">
					<input type="hidden" name="userid" id="sid"
						value=<%=request.getAttribute("userid")%>> <input
						type="hidden" name="level" id="vid"> <input type="hidden"
						name="action" id="act"> <br>
					<div id="div1" style="display: none;">
						Tên lớp:<input type="text" name="classname" id="input1"><input
							type="submit" value="Lưu" onclick="DoAction(1)">
					</div>
					<div id="div2" style="display: none;">
						Mã lớp học<input type="text" name="oldclassid" id="input2"><input
							type="submit" value="Xóa" onclick="DoAction(2)">
					</div>
					<br>
				</form>
				<form action="LoadStudentInClass" method="get">
					<input type="hidden" name="classid" id="hide1"> <input
