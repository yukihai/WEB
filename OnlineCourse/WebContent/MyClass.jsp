...
<div id="div1" style="display: none;">Tên lớp:<input type="text" name="classname" id="input1"><input type="submit" value="Lưu" onclick="DoAction(1)"></div>
<div id="div2" style="display: none;">Mã lớp học<input type="text" name="oldclassid" id="input2"><input type="submit" value="Xóa" onclick="DoAction(2)"></div>
</form>
