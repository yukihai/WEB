...
<div id="hide0">				
<button onclick="Toggle(div1,div2)">Thêm đề thi cho lớp học</button>
...
<div id="div1" style="display: none;">Mã đề thi:<input type="text" name="selectedtestid" id="input1">Mã lớp học:<input type="text" name="selectedclassid" id="input2"><input type="submit" value="Lưu" onclick="DoAction(1)"></div>
<div id="div2" style="display: none;">Mã đề thi cần xóa:<input type="text" name="oldtestid" id="input3"><input type="submit" value="Xóa" onclick="DoAction(2)"></div>
</form>
