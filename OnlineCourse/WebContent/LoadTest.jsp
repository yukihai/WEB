...
<div id="hide0">				
<button onclick="Toggle(div1,div2)">Thêm bài kiểm tra</button>
<button onclick="Toggle(div2,div1)">Xóa bài kiểm tra</button>
</div>

<div id="hide4">
<button onclick="Toggle(div3)">Thêm bài thi cho lớp học</button>
</div>
