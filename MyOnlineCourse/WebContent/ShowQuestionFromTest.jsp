	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item dropdown"><a
				...
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> <i class="fas fa-portrait"></i> <span>Tài khoản cá nhân</span>
			</a>
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#" style="color: black"><h5>Thêm
								câu hỏi</h5></a></li>
				</ol>
				<form action="EditTest" method="get">
					...
					<input type="hidden" id="hide2" name="action">
					 <input type="hidden" id="hide3" name="stt"> Mã môn học 
					 <input type="text" name="courseid"> Mã câu hỏi
					 <input type="text" name="questionid"><button onclick="Add()">Lưu</button>
					${table}
				</form>
				<!-- Sticky Footer -->
