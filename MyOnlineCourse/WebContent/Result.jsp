					...
					<div class="container-fluid">
						...
						<ol class="breadcrumb">
							<li class="breadcrumb-item">
								<a href="#" style="color: black"><h5>Kết quả của sinh viên</h5></a>			
							</li>
						</ol>
...
<table class="table">
	<tbody>
	<tr>
		<th scope="row">Tên bài kiểm tra: </th>
		<td><%=request.getAttribute("title") %></td>
	</tr>
	<tr>
		<th scope="row">Tên thí sinh: </th>
	...
	<tr>
		<th scopr="row">Điểm của bạn: </th>
		<td><%=request.getAttribute("point") %></td>
	</tr>
	</tbody>
</table>
<button onclick="myFunction()" class="fa fa-print"> In kết quả</button><br><br>
	<a href="Home.jsp"><button class="btn btn-success"> Trang chủ</button></a>
</form>
