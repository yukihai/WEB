			...
			<div class="container-fluid">
				<form action="AddNewTest" method="post">
					...
					<div class="form-group row">
						<div class="col-sm-11">
							Tiêu đề: <input type="text" class="form-control" name="title" required="required">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-11">
							Thời gian: <input type="text" class="form-control" name="period" required="required">
						</div>
					</div>
					<center>

						<input type="submit" class="btn btn-info" value="Tạo đề thi">
